...
echo "=========================================="
echo "      开始构建 生产版本 (Production/Release)"
echo "=========================================="
...
# 3. 切换到 iOS 目录，执行 pod install 并使用 fastlane 构建生产发布包
echo "--> 5/5: 开始打包 iOS (pod install & fastlane buildRelease)..."
cd "$PROJECT_ROOT/ios"
echo "    执行 pod install..."
pod install

echo "    执行 fastlane buildRelease..."
